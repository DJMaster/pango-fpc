//
// pango.h header binding for the Free Pascal Compiler aka FPC
//
...
{$include pango_matrix.inc}
{$include pango_gravity.inc}
{$include pango_coverage.inc}
{$include pango_font.inc}
{$include pango_fontset.inc}
{$include pango_fontmap.inc}
{$include pango_item.inc}
{$include pango_tabs.inc}

{$include pango_attributes.inc}
{$include pango_bidi_type.inc}
{$include pango_break.inc}
{$include pango_context.inc}
{$include pango_engine.inc}
{$include pango_enum_types.inc}
{$include pango_features.inc}
{$include pango_glyph.inc}
{$include pango_glyph_item.inc}
{$include pango_layout.inc}
{$include pango_renderer.inc}
{$include pango_utils.inc}
